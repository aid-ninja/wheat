...
5. **Determine evidence tier** based on source type:
   ...
   - Conference talks, interviews → `web`
...
7. **Handle ambiguous support**: If the evidence is ambiguous (e.g., "http module is stable but has had breaking changes"), present your reasoning for the classification and tell the user they can override by editing the claim.
