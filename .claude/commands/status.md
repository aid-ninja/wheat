...
4. **Generate dashboard HTML**: Create/update `output/dashboard.html` — a self-contained dashboard page using the template from `templates/dashboard.html`. The dashboard must show:
