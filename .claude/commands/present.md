...
3. **Generate presentation HTML**: Create `output/presentation.html` — a self-contained, scroll-snap presentation using the dark theme template from `templates/explainer.html`.
