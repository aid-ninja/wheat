...
Create `research/<topic-slug>.html` — a self-contained HTML explainer using the dark scroll-snap template style from `templates/explainer.html`. This should be:
